...
(4,1,'Rangamati','রাঙ্গামাটি','22.65335891','92.17886139','www.rangamati.gov.bd'),
...
(9,1,'Coxsbazar','কক্সবাজার','21.44305765','91.97378522','www.coxsbazar.gov.bd'),
...
(15,2,'Rajshahi','রাজশাহী','24.372268','88.56306295','www.rajshahi.gov.bd'),
(16,2,'Natore','নাটোর','24.420556','89.000282','www.natore.gov.bd'),
(17,2,'Joypurhat','জয়পুরহাট','25.0964922','89.04006425','www.joypurhat.gov.bd'),
(18,2,'Chapainawabganj','চাঁপাইনবাবগঞ্জ','24.5965034','88.2775122','www.chapainawabganj.gov.bd'),
(19,2,'Naogaon','নওগাঁ','24.83266902','88.92479841','www.naogaon.gov.bd'),
(20,3,'Jashore','যশোর','23.16643','89.2081126','www.jessore.gov.bd'),
(21,3,'Satkhira','সাতক্ষীরা','22.71814617','89.06860564','www.satkhira.gov.bd'),
...
(30,4,'Jhalakathi','ঝালকাঠি','22.64234943','90.19994261','www.jhalakathi.gov.bd'),
(31,4,'Patuakhali','পটুয়াখালী','22.3596316','90.3298712','www.patuakhali.gov.bd'),
(32,4,'Pirojpur','পিরোজপুর','22.57683082','89.9895851','www.pirojpur.gov.bd'),
(33,4,'Barisal','বরিশাল','22.70042784','90.37275993','www.barisal.gov.bd'),
(34,4,'Bhola','ভোলা','22.685923','90.648179','www.bhola.gov.bd'),
(35,4,'Barguna','বরগুনা','22.15925181','90.12505531','www.barguna.gov.bd'),
...
(42,6,'Shariatpur','শরীয়তপুর','23.20599979','90.34735414','www.shariatpur.gov.bd'),
(43,6,'Narayanganj','নারায়ণগঞ্জ','23.63366','90.496482','www.narayanganj.gov.bd'),
(44,6,'Tangail','টাঙ্গাইল','24.26363262','89.91793249','www.tangail.gov.bd'),
(45,6,'Kishoreganj','কিশোরগঞ্জ','24.444937','90.776575','www.kishoreganj.gov.bd'),
(46,6,'Manikganj','মানিকগঞ্জ','23.86025572','90.00084225','www.manikganj.gov.bd'),
(47,6,'Dhaka','ঢাকা','23.7115253','90.4111451','www.dhaka.gov.bd'),
(48,6,'Munshiganj','মুন্সিগঞ্জ','23.54371231','90.53488677','www.munshiganj.gov.bd'),
...
(55,7,'Lalmonirhat','লালমনিরহাট','25.91643923','89.4505802','www.lalmonirhat.gov.bd'),
...
--
ALTER TABLE `districts`
  ADD CONSTRAINT `districts_fk_divisions` FOREIGN KEY (`division_id`) REFERENCES `divisions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
